                    ...
                    {items.map((item) => (
                        <li key={item._id} style={styles.item}>
                            <label style={styles.itemLabel}>
                                <input type="checkbox" checked={Boolean(item.completed)} onChange={() => onToggleComplete(item)} />
                                <div>
                            ...
                            <button onClick={() => onDelete(item._id)} style={styles.deleteButton}>Remove</button>
                        </li>
                    ))}
                </ul>
            )}
